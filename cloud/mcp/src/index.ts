...
const TOOLS = [
  ...
  { name: 'watch_summarize_workouts', scope: WATCH_READ_SCOPE, description: 'Summarize workout count, duration, distance, steps, total calories burned, and overall average heart rate.', inputSchema: EMPTY_SCHEMA },
